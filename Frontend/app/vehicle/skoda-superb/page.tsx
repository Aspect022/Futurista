...
export default function SkodaSuperbPage({ params }: { params: { id: string } }) {
  // Placeholder: validate vehicle id if needed
  if (!params?.id) return notFound()

  const v = skodaSuperbData;
          ...
          <div className="mb-6">
            <Breadcrumb className="text-black/60">
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbPage className="text-black font-medium">Skoda Superb</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
          ...
          <header className="mb-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
              <div>
                ...
                <p className="text-gray-600 mt-2">Comprehensive predictive maintenance for your premium sedan</p>
              </div>
            ...
            <div className="mt-4">
              ...
              <div className="flex flex-wrap gap-2">
                {v.features.map((feature, index) => (
                  <span 
                    key={index} 
                    className="px-2 py-1 text-xs bg-blue-50 text-blue-800 rounded-full border border-blue-200"
                  >
                    {feature}
                  </span>
                ))}
            ...
            items={[
              {
                ...
                severity: "medium",
                description: "Temperature variance within acceptable range",
              },
              {
                ts: "2025-10-14 10:05",
                metric: "Engine vibration",
                severity: "low",
                description: "Minimal vibration detected during idling",
              },
            ]}
          />
        </section>
